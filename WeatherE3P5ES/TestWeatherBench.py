...
args_dict = {}
weight_decay, scheduler_gamma, lr, epochs, early_stopping, epochs_early_stopping_interval = 0, 1, 0.001, 100, True, 5 #Original Learning rate 0.01 
...
# name_postfix = "_mytrainedmodelSignatureKernel"  # or something else descriptive
